        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='wuzi'">
                    <el-form-item class="select" v-if="type!='info'"  label="物资信息" prop="wuziId">
                        <el-select v-model="ruleForm.wuziId" :disabled="ro.wuziId" filterable placeholder="请选择物资信息" @change="wuziChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='wuzi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="物资编号" prop="wuziUuidUnmber">
                        <el-input v-model="wuziForm.wuziUuidUnmber"
                ...
                <el-col :span="12"  v-if="sessionTable !='wuzi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="最低预警值" prop="wuziMin">
                        <el-input v-model="wuziForm.wuziMin"
                                  placeholder="最低预警值" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='wuzi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="最高预警值" prop="wuziMax">
                        <el-input v-model="wuziForm.wuziMax"
                                  placeholder="最高预警值" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='wuzi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="物资单位" prop="wuziDanwei">
                        <el-input v-model="wuziForm.wuziDanwei"
                                  placeholder="物资单位" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='wuzi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="供应商" prop="wuziGongyingshang">
                        <el-input v-model="wuziForm.wuziGongyingshang"
                                  placeholder="供应商" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
